         ...
         <li class="no-padding">
            <ul class="collapsible collapsible-accordion">
               <li>
                  ...
                  <div class="collapsible-body">
                     <ul>
                        <form class="sidebar-form" name="nome" action="pesquisar_pedido.php" method="post">
                           <div class="input-group">
                              <li><a href="cadastrar_pedido.php"><i class="material-icons">add</i>Cadastrar</a></li>
                              <li><input type="text" name="nome" class="form-control" placeholder="Pesquisar..."/></li>
                              <li hidden><input name="SendPesqUser" type="submit" value="Pesquisar"></li>
                           </div>
                        </form>
      ...
      <main>
          <section class="content">
            <nav>
               <div class="nav-wrapper">
                  ...
                  <ul class="right hide-on-med-and-down">
                     ...
                     <li>
                        <form action="pesquisar_pedido.php" method="post">
                           <input type="text" name="nome" placeholder="Buscar Pedido">
                           <input hidden name="SendPesqUser" type="submit" value="Pesquisar">
                        </form>
                     </li>
                     <li><a href="listar_pedido.php"><i class="material-icons right">list</i>Listar</a></li>
                  </ul>
               </div>
            </nav>
            <!--  -->
            <div class="container"/>
               ...
               <div class="custom-responsive">
                  <table class="striped hover centered">
                     ...
                     <?php
                       ...
                       /* $result_pedidos = "SELECT idCliente, dataPedido, idPedido, idProduto, quantidade FROM pedidos p INNER JOIN item_pedido i ON p.idPedido = i.idPedido LIMIT $inicio, $qnt_result_pg";
                        $resultado_pedidos = mysqli_query($conn, $result_pedidos);
                        while($row_pedido = mysqli_fetch_assoc($resultado_pedidos)){
                          echo "<tr><td>". $row_pedido['idCliente'] . "</td>";
                          echo "<td>" . $row_pedido['idPedido'] . "</td>";
                          echo "<td>" . $row_pedido['dataPedido'] . "</td>";
                          echo "<td>" . $row_pedido['idProduto'] ."</td>";
                          echo "<td>" . $row_pedido['quantidade'] ."</td>";
                          echo "<td><a href='editar_pedido.php?id=" . $row_pedido['id'] . "'>Editar</a></td>";
                          echo "<td><a href='proc_apagar_pedido.php?id=" . $row_pedido['id'] . "'>Apagar</a></td></tr>";
                        }
                        ?>*/

                        $result_pedidos = "SELECT * FROM pedidos LIMIT $inicio, $qnt_result_pg";
                        $resultado_pedidos = mysqli_query($conn, $result_pedidos);
                        while($row_pedido = mysqli_fetch_assoc($resultado_pedidos)){
                          echo "<tr><td>". $row_pedido['idCliente'] . "</td>";
                          //echo "<td>" . $row_pedido['idPedido'] . "</td>";
               ...
               <?php
                  //Paginção - Somar a quantidade de pedidos
                  $result_pg = "SELECT COUNT(id) AS num_result FROM pedidos";
                  ...
                  $max_links = 2;
                  echo "<a href='listar_pedido.php?pagina=1'>Primeira</a> ";
                  
                  for($pag_ant = $pagina - $max_links; $pag_ant <= $pagina - 1; $pag_ant++){
                    if($pag_ant >= 1){
                      echo "<a href='listar_pedido.php?pagina=$pag_ant'>$pag_ant</a> ";
                    }
                  }
                  ...
                  for($pag_dep = $pagina + 1; $pag_dep <= $pagina + $max_links; $pag_dep++){
                    if($pag_dep <= $quantidade_pg){
                      echo "<a href='listar_pedido.php?pagina=$pag_dep'>$pag_dep</a> ";
                    }
                  }
                  
                  echo "<a href='listar_pedido.php?pagina=$quantidade_pg'>Ultima</a>";
