         ...
         <section class="content">
            ...
            <div class="container"/>
               ...
               <?php
                  ...
                  ?>
               <form method="POST" action="proc_cad_pedido.php">
                  <label>ID Cliente: </label>
                  <input type="text" name="idCliente" placeholder="Digite o nome"><br><br>
                  <label>Data: </label>
                  <input type="text" name="dataPedido" placeholder="Digite a descrição"><br><br>         
                  <!--<label>ID Pedido: </label>
                     <input type="text" name="idPedido" placeholder="Digite o ID do pedido"><br><br>  
                     
                     <label>ID Produto: </label>
                     <input type="text" name="idProduto" placeholder="Digite o ID do produto "><br><br>
