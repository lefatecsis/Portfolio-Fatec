<?php
   ...
   $result_pedido = "SELECT * FROM pedidos WHERE id = '$id'";
         ...
         <section class="content">
            ...
            <div class="container"/>
               ...
               <?php
                  ...
                  ?>
               <form method="POST" action="proc_edit_pedido.php">
                  <input type="hidden" name="id" value="<?php echo $row_pedido['id']; ?>">
                  <label>ID Cliente: </label>
                  <input type="text" name="idCliente" placeholder="Digite o idCliente" value="<?php echo $row_pedido['idCliente']; ?>"><br><br>
                  <label>Data Pedido: </label>
                  <input type="text" name="dataPedido" placeholder="Digite o dataPedido" value="<?php echo $row_pedido['dataPedido']; ?>"><br><br>
                  <!--<label>ID Pedido: </label>
                     <input type="text" name="idPedido" placeholder="Digite o idPedido" value="<?php echo $row_pedido['idPedido']; ?>"><br><br>
                     
                     <label>ID Produto: </label>
                     <input type="text" name="idProduto" placeholder="Digite o e-mail" value="<?php echo $row_pedido['idProduto']; ?>"><br><br>
                     
                     <label>Quantidade: </label>
                     <input type="text" name="quantidade" placeholder="Digite o e-mail" value="<?php echo $row_pedido['quantidade']; ?>"><br><br>-->
