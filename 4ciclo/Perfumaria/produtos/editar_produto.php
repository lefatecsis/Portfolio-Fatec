   ...
   <body>
         ...
         <li class="no-padding">
            <ul class="collapsible collapsible-accordion">
               <li>
                  ...
                  <div class="collapsible-body">
                     <ul>
                        <form class="sidebar-form" name="nome" action="pesquisar_produto.php" method="post">
                           <div class="input-group">
                              <li><a href="cadastrar_produto.php"><i class="material-icons">add</i>Cadastrar</a></li>
                              <li><input type="text" name="nome" class="form-control" placeholder="Pesquisar..."/></li>
                              <li hidden><input name="SendPesqUser" type="submit" value="Pesquisar"></li>
                           </div>
                        </form>
      ...
      <main>
            ...
            <nav>
               <div class="nav-wrapper">
                  ...
                  <ul class="right hide-on-med-and-down">
                     ...
                     <li><a href="listar_produto.php"><i class="material-icons right">list</i>Listar</a></li>
                  </ul>
               </div>
            </nav>
            <!--  -->
		...
		<form method="POST" action="proc_edit_produto.php">
			...
			<label>Nome: </label>
			<input type="text" name="nome" placeholder="Digite o nome" value="<?php echo $row_produto['nome']; ?>">
			
			<label>Descrição: </label>
			<input type="text" name="descricao" placeholder="Digite o descricao" value="<?php echo $row_produto['descricao']; ?>">

			<label>Valor: </label>
			<input type="text" name="valor" placeholder="Digite o valor" value="<?php echo $row_produto['valor']; ?>">

			<label>Estoque: </label>
			<input type="text" name="estoque" placeholder="Digite o e-mail" value="<?php echo $row_produto['estoque']; ?>">		
