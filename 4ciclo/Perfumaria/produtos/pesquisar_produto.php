                     ...
                     <?php		
                        ...
                        if($SendPesqUser){
                        	...
                        	while($row_produto = mysqli_fetch_assoc($resultado_produto)){
                        		echo "<tr><td>". $row_produto['id'] . "</td>";
                                echo "<td>" . $row_produto['nome'] . "</td>";
                                echo "<td>" . $row_produto['descricao'] . "</td>";
                                echo "<td>" . $row_produto['valor'] ."</td>";
                                echo "<td>" . $row_produto['estoque'] ."</td>";
                                echo "<td><a href='editar_produto.php?id=" . $row_produto['id'] . "'>Editar</a></td>";
                                echo "<td><a href='proc_apagar_produto.php?id=" . $row_produto['id'] . "'>Apagar</a></td></tr>";
                        	}
                        }
                        ?>
                  </table>
